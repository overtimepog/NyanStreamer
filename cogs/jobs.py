...
"<:reply:1245851809730396210> <:replycontinued:1245851813022793778>"
rarity_colors = {
...
class Jobs(commands.Cog, name="jobs"):
    ...
    async def acceptjob(self, ctx: Context, job: str):
        ...
        if user_job is None or user_job == 0 or user_job == "None":
            ...
            await ctx.send("You already have a job!, please use `s.job quit or /job quit` command to quit your current job.")
