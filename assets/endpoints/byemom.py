...
class Byemom():
    ...
    def generate(self, avatars, text, usernames, kwargs):
        base = Image.open(('assets/assets/byemom/mom.bmp'))
        ...
        font = ImageFont.truetype('assets/assets/fonts/arial.ttf', size=20)
        bye_font = ImageFont.truetype('assets/assets/fonts/arimobold.ttf', size=14)
