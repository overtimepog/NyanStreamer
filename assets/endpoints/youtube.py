...
class Youtube():
    ...
    def generate(self, avatars, text, usernames, kwargs):
        ...
        name = usernames[0]
        base = Image.open(('assets/assets/youtube/youtube.bmp')).convert('RGBA')
        font = ImageFont.truetype('assets/assets/fonts/robotomedium.ttf', size=17, )
        font2 = ImageFont.truetype('assets/assets/fonts/robotoregular.ttf', size=17, )
        font3 = ImageFont.truetype('assets/assets/fonts/robotoregular.ttf', size=19, )
