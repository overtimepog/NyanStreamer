...
class ChangeMyMind():
    ...
    def generate(self, avatars, text, usernames, kwargs):
        base = Image.open(('assets/assets/changemymind/changemymind.bmp')).convert('RGBA')
        # We need a text layer here for the rotation
        text_layer = Image.new('RGBA', base.size)
        font, text = auto_text_size(text, ImageFont.truetype('assets/assets/fonts/sans.ttf'), 310)
